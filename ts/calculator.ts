...
function CurIsOperator(): boolean {
  if (
...
function multi(num: string, num2: string): number {
  return parseFloat(num) * parseFloat(num2);
}
function divide(num: string, num2: string): number {
  return parseFloat(num) / parseFloat(num2);
}
function sum(num: string, num2: string): number {
  return parseFloat(num) + parseFloat(num2);
}
function sub(num: string, num2: string): number {
  return parseFloat(num) - parseFloat(num2);
}

//buttons functions

function evalButton(): void {
  if (!calc.seintificMode) {
    calculete();
  } else {
    sciCalculete();
