...
mode.addEventListener('click', function () { var el = document.body; el.classList.toggle('dark'); });
var info = document.querySelector('#info');
info.addEventListener('click', function (e) { alert('Developer’s name:Marina\nCalculator’s version:1.0.0\nthis is a calculetor'); });
